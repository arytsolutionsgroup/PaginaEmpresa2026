			...
			<div class="row">
				<div class="col-lg-12 text-center">
						<div class="owl-carousel">
							<div class="item">
								<div class="partner-logo"><img src="images/icon-node-js.png" alt="node"></div>
							</div>
							<div class="item">
								<div class="partner-logo"><img src="images/icon-react-js.png" alt="react"></div>
							</div>
							<div class="item">
								<div class="partner-logo"><img src="images/icon-html-5.png" alt="html5"></div>
							</div>
							<div class="item">
								<div class="partner-logo"><img src="images/icon-css-3.png" alt="css3"></div>
							</div>
							<div class="item">
								<div class="partner-logo"><img src="images/icon-dot-net.png" alt=".Net"></div>
							</div>
							<div class="item">
								<div class="partner-logo"><img src="images/icon-cisco-black.png" alt="Cisco"></div>
							</div>
							<div class="item">
								<div class="partner-logo"><img src="images/icon-siemens.png" alt="Siemens"></div>
							</div>
							<div class="item">
								<div class="partner-logo"><img src="images/icon-schneider.png" alt="Schneider Electric"></div>
							</div>
							<div class="item">
								<div class="partner-logo"><img src="images/icon-tyco.png" alt="TycoSecurityProducts"></div>
							</div>
							<div class="item">
								<div class="partner-logo"><img src="images/icon-microchip.png" alt="Microchip"></div>
							</div>
							<!--div class="item">
								<div class="partner-logo"><img src="images/icon-X.png" alt="X"></div>
							</div>
							<div class="item">
								<div class="partner-logo"><img src="images/icon-XX.png" alt="XX"></div>
							</div>
							<div class="item">
		...
		<section id="services" class="light">
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="ot-portfolio-item">
						<figure class="effect-bubba">
							<img src="images/port8-electric.jpg" alt="img01" class="img-responsive" />
							<figcaption>
								<h2>Electrical</h2>
								<p>Learn more</p>
				...
				<div class="col-md-6">
					<div class="ot-portfolio-item">
						<figure class="effect-bubba">
							<img src="images/port6-domotics-iot.jpg" alt="IT Consulting" class="img-responsive" />
							<figcaption>
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="ot-portfolio-item">
						<figure class="effect-bubba">
							<img src="images/port4-compnetworks.jpeg" alt="Informatics Security" class="img-responsive" />
							<figcaption>
				...
				<div class="col-md-6">
					<div class="ot-portfolio-item">
						<figure class="effect-bubba">
							<img src="images/port1-webdesign.jpeg" alt="img02" class="img-responsive" />
							<figcaption>
								<h2>Software development</h2>
								<p>Learn more</p>
